...
class DeepseekLLM implements LLM {
  ...
  /// Constructs the POST body for the API request.
  ...
  /// Constructs the headers for the POST request.
  ...
  ///Modern method used in the Lesson Plan feature to interact with the AI model.
  @override
